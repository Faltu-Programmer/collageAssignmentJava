...
public class BankAccount
{
    ...
    private final String m_typeOfAccount;  /// 1 type is savings and 2 is current 
    ...
    /*
    /// this feature will not be implemented beacause one accountHolder can have
    /// one account only
    ...
    */
    ...
    public void setBalance (int t_balance)
    {
